table 25006382 "Option Sales Price"
{
    // 11.04.2013 EDMS P8
    ...
    Caption = 'Option Sales Price';
    LookupPageID = 25006519;
    ...
    fields
    {
        ...
        field(130;"VAT Bus. Posting Gr. (Price)";Code[10])
        {
    ...
    keys
    {
        key(Key1;"Make Code","Model Code","Model Version No.","Option Type","Option Subtype","Option Code","Sales Type","Sales Code","Starting Date","Currency Code")
        {
            Clustered = true;
        }
    }
