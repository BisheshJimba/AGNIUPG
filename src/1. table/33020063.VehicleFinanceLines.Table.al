table 33020063 "Vehicle Finance Lines"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("Vehicle Finance Payment Lines"."Prepayment Paid" WHERE (Loan No.=FIELD(Loan No.),
                                                                                       Installment No.=FIELD(Installment No.)));
            FieldClass = FlowField;
        }
        field(61;"Defer Principal";Boolean)
        {
        }
        field(62;"Deferred Principal";Decimal)
        {
        }
        field(63;"Loan Capitalized";Boolean)
        {
        }
        ...
        field(50004;"Wave Penalty Reason Code";Code[30])
        {
            TableRelation = "Reason Code".Code WHERE (Group=CONST(Wave Penalty));
        }
