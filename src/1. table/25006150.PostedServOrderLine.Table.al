table 25006150 "Posted Serv. Order Line"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Posted Serv. Order Header"."Order No." WHERE (No.=FIELD(Document No.)));
            FieldClass = FlowField;
        }
    ...
    [Scope('Internal')]
    procedure CalcVATAmountLines(var PostServOrd: Record "25006149";var VATAmountLine: Record "290")
    begin
