pageextension 50607 pageextension50607 extends "Purchase Return Order List"
{
    layout
    {
    ...
    actions
    {
        ...
        //Unsupported feature: Property Modification (RunPageLink) on "Action 1102601029".


        //Unsupported feature: Property Modification (RunPageLink) on "Action 1102601036".


        //Unsupported feature: Property Modification (RunPageLink) on "Action 1102601035".
