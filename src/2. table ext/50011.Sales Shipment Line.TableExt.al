tableextension 50011 tableextension50011 extends "Sales Shipment Line"
{
    // 22.10.2016 NAV2016 Merge
    //   ShowItemSalesInvLines set to public
    // 
    // 08.04.2013 EDMS P8
    ...
    fields
    {
        ...
        field(25006130; "External Serv. Tracking No."; Code[20])
        {
            ...
            // TableRelation = IF (Type=FILTER("External Service")) "External Serv. Tracking No."."External Serv. Tracking No." WHERE ("External Service No."=FIELD("No.")); //need to add external service in type
        }
        ...
        {
            BlankZero = true;
            CaptionClass = '7,111,25006996';
        }
        field(25006997; "Variable Field Run 3"; Decimal)
        {
            BlankZero = true;
            CaptionClass = '7,111,25006997';
        }
        ...
        field(33020261; "Sales Invoiced"; Boolean)
        {
            // FieldClass = FlowField;
            // CalcFormula = Exist("Sales Invoice Line" WHERE ("Vehicle Serial No."=FIELD("Vehicle Serial No.")));//need to add field in sales invoice line
        }
        field(33020262; "Sell-to Customer Name"; Text[100])
        {
            FieldClass = FlowField;
