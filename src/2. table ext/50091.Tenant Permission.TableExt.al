tableextension 50091 tableextension50091 extends "Tenant Permission"
{
    fields
    {

        //Unsupported feature: Property Modification (CalcFormula) on ""Role Name"(Field 3)".
        ...
        //Unsupported feature: Property Modification (CalcFormula) on ""Object Name"(Field 6)".
