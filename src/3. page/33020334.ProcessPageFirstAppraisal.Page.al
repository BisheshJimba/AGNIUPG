page 33020334 "Process Page-First Appraisal"
{
    ...
    layout
    {
        area(content)
        {
            ...
            field("Apprisal Type"; ApprisalType)
            {
            }
        }
    }
            ...
            action("<Action1000000004>")
            {
                ...
                begin
                    ...
                    IF Appraisal.FIND('-') THEN BEGIN
                        IF Appraisal.IsAppraised1 THEN
                        ...
                        ELSE BEGIN
                            ...
                            Appraisal.SetApprisalType(ApprisalType);
                            Appraisal.VALIDATE("Apprisal Type", ApprisalType);
                            // MESSAGE(FORMAT(ApprisalType));
                            Appraisal.MODIFY;
                            EmpAppr1.RESET;
                    ...
                    ELSE BEGIN
                        ...
                        END ELSE BEGIN
                            ...
                            EmpAppr1."Appraiser 2" := "Second Appraisal ID";
                            EmpRec1.RESET;
                            EmpRec1.SETRANGE("No.", "Second Appraisal ID");
                            IF EmpRec1.FINDFIRST THEN BEGIN
                                EmpAppr1."Appraiser 2 Name" := EmpRec1."Full Name";
                                EmpAppr1."Appraiser 2 Designation" := EmpRec1."Job Title";
                            END;

                            EmpAppr1."Join Date" := "Employment Date";
                            EmpAppr1."Level/Grade" := "Grade Code";
                            EmpAppr1."Appraisal Type" := EmpAppr1."Appraisal Type"::Annual;
                            EmpAppr1."Fiscal Year" := FiscalYear;
                            EmpAppr1.StartFiscalYear := StartFiscalYear;
                            EmpAppr1.SetApprisalType(ApprisalType);
                            EmpAppr1.VALIDATE("Apprisal Type", ApprisalType); //app type
                            EmpAppr1.VALIDATE(Department, "Department Code");
                            ...
                            EmpAppr1.SetApprisalType(ApprisalType);
                            EmpAppr1.VALIDATE("Apprisal Type", ApprisalType);
                            EmpAppr1.MODIFY;
    ...
    var
        ...
        AppraisalHistoryPage: Page "33020434";
        Text001: Label 'The Appraisal has not been set by HR Department!';
