page 50045 "Vehicle Card (with flowfields)"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("First Registration Date"; "First Registration Date")
                {
                    Editable = allowmodifyall;
                }
                field("First Registration Date (BS)"; "First Registration Date (BS)")
                {
                }
                field("Registration Amount"; "Registration Amount")
                {
                    Editable = allowmodifyall;
                }
                ...
                field("Registration Certificate No."; "Registration Certificate No.")
                {
                    Editable = allowmodifyall;
                }
                ...
                field("Tracking Code"; "Tracking Code")
                {
                    Editable = allowmodifyall;
                }
                field("Interior Code"; "Interior Code")
                {
                    Editable = allowmodifyall;
                }
                field("Body Color Code"; "Body Color Code")
                {
                    Editable = allowmodifyall;
                }
                ...
                field("AMC Registered"; "AMC Registered")
                {
                    Editable = allowmodifyall;
                }
                ...
                field("Current Location of VIN"; "Current Location of VIN")
                {
                    Editable = false;
                }
                ...
                field("Location After Sale"; "Location After Sale")
                {
                    Editable = allowmodifyall;
                }
                ...
                field("Serv. Ledger Entry Exist"; "Serv. Ledger Entry Exist")
                {
                    Editable = allowmodifyall;
                }
                ...
                field("Commission Posted"; "Commission Posted")
                {
                }
                field("Total Commission Paid"; "Total Commission Paid")
                {
                    Visible = CommissionRead;
                }
                field("Customer No."; "Customer No.")
                {
                }
                field("Sahamati Location"; "Sahamati Location")
                {
                }
                field("Sahamati Date"; "Sahamati Date")
                {
                }
                field("Sahamati Date (BS)"; "Sahamati Date (BS)")
                {
                }
                ...
                field("Default Vehicle Acc. Cycle No."; "Default Vehicle Acc. Cycle No.")
                {
                    ...
                    begin
                        ...
                        IF cuLookupMgt.LookUpVehicleAccCycle(recVehAccCycleNo, "Serial No.", "Default Vehicle Acc. Cycle No.") THEN;
                    end;
                }
                field(ServLedgerEntryExist; ServLedgerEntryExist)
                {
                    ...
                    begin
                        ...
                        IF FORMAT("Date Filter") <> '' THEN
                            ServiceLedgerEntry.SETRANGE("Posting Date", "Date Filter");
                        PAGE.RUNMODAL(PAGE::"Service Ledger Entries EDMS", ServiceLedgerEntry);
                    end;
                }
                field("Parent Component"; "Parent Component")
                {
                }
