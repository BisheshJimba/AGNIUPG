page 33020165 "CC Memo List"
{
    CardPageID = "CC Memo Card";
    Editable = false;
    PageType = List;
            ...
            group("<Action1102159022>")
            {
                ...
                action(Print_CCMemo)
                {
                    ...
                    begin
                        ...
                        //IF LclHasValue THEN BEGIN  ** SM 27-06-2013 commented coz no insurance memo before custom clearance at Agni
