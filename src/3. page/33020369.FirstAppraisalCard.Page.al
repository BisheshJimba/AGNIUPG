page 33020369 "First Appraisal Card"
{
    ...
    begin
        ...
        IF Appraisal.FIND('-') THEN BEGIN
           ...
           JobTitle.SETRANGE(JobTitle.Description,Appraisal.Designation);
           ...
           END;
           //EndFiscalDate := Appraisal."Fiscal Year";
