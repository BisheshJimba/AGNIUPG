page 33019968 "Stock-Fuel Issue Entry List"
{
    CardPageID = "Stock-Fuel Issue Entry Card";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    SourceTableView = WHERE(Document Type=FILTER(Stock));
            ...
            group("Function")
            {
                ...
                action(SendAppReq)
                {
                    ...
                    begin
                        ...
                        GblDocAppMngt.sendAppReqFuelIssue(DATABASE::"Fuel Issue Entry",GblDocType::"Fuel Issue","No.",GblEntryType::Stock);
                    end;
                }
                action(CancelAppReq)
                {
                    ...
                    begin
                        ...
                        GblDocAppMngt.cancelAppReqFuelIssue(DATABASE::"Fuel Issue Entry",GblDocType::"Fuel Issue","No.",GblEntryType::Stock);
                    end;
                }
            }
        }
            ...
            group("<Action1102159061>")
            {
                ...
                action(Fuel_Coupon)
                {
                    ...
                    begin
                        ...
                        REPORT.RUN(33019963,TRUE,TRUE,FuelIssueEntry);
                    end;
                }
            }
        }
