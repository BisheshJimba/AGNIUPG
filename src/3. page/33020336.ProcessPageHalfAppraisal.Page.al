page 33020336 "Process Page- Half Appraisal"
{
    ...
    actions
    {
        area(creation)
        {
            ...
            {
                Caption = 'Do Half Year Appraisal';
                Image = Post;
                Promoted = true;
                ...
                begin
                    ...
                    Appraisal.SETRANGE(Appraisal."Appraisal Type", Appraisal."Appraisal Type"::"Half-Annual");
                    IF Appraisal.FIND('-') THEN BEGIN
                        ...
                        ELSE BEGIN
                            ...
                            Appraisal."Apprisal Type" := ApprisalType;
                            Appraisal.MODIFY;
                            Appraisal.VALIDATE(Department);
                            Appraisal.MODIFY;
                            EmpAppr1.RESET;
                    ...
                    ELSE BEGIN
                        ...
                        END ELSE BEGIN
                            ...
                            EmpAppr1."Appraisal Type" := EmpAppr1."Appraisal Type"::"Half-Annual";
