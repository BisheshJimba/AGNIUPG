page 33019896 "Posted Job Card"
{
        ...
        area(processing)
        {
            group("<Action1000000001>")
            {
                ...
                action("<Action1000000002>")
                {
                    ...
                    begin
                         //msg('123');
                         MyRecord.SETRANGE("Job Card No.","Job Card No.");
                         IF MyRecord.FIND('-') THEN BEGIN
                            MyRecord."No. of Months" := Month;
                            MyRecord."Vehicle Type" := "Vehicle Type";
                            MyRecord."Pro-Rata %" := "Warranty Percentage";
                            //MESSAGE('%1',MyRecord."Vehicle Type");
                            //MESSAGE('%1',MyRecord."Pro-Rata %");
                            MyRecord.MODIFY;
                            IF MyRecord.MODIFY THEN
                               MESSAGE(text0003)
                            ELSE
                               MESSAGE(text0004);
                         END;
    ...
    var
        ...
        text0003: Label 'Changes is done successfully.';
        text0004: Label 'No changes affects.';
}
