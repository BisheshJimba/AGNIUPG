page 33020372 "Second Appraisal Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Knowledge & Performance")
            {
                ...
                {
                    Caption = 'Knowledge & Skills - Possession knowledge & skills and its updating ability in applying knowledge to carry out his work';

                    trigger OnValidate()
                    begin
                        "Total App2" := CalculateAppraisalScore;
                    end;
                }
                field(QOW2; QOW2)
                {
                ...
                {
                    Caption = 'Cost Conciousness Ù Efforts towards optimum utilization of available resources ';
            ...
            group("Personal Attributes")
            {
                ...
                {
                    Caption = 'Initiative Ù Ability to be self reliant and resourceful, ability to carry out task without outside guidance ';
                ...
                {
                    Caption = 'Discipline Ù Adherence to expected standards of conduct, following instructions, punctuality & responsibility';
            ...
            group("Management Attributes")
            {
                ...
                {
                    Caption = 'Planning & Organizing Ù Planning and setting priorities, understanding objectives and developing realistic and workable plans';
            ...
            group("_Management Attributes")
            {
                ...
                {
                    Caption = 'Planning & Organizing Ù Planning ahead, setting priorities, understanding objectives and developing realistic and workable plans, developing work teams, distributing & assigning work opportunity';
                ...
                field("_Decision Making2>"; "Decision Making2")
                {
            ...
            group("Appraisal Criteria")
            {
                ...
                field("_KnowledgeSkill2>"; KnowledgeSkill2)
                {
            ...
            group(Others)
            {
                ...
                {
                    Caption = 'General Remarks bt 2nd Appraiser';
                    MultiLine = true;
                }
                field("Remarks by HR"; "Remarks by HR")
                {
                    Caption = 'Remarks/ Feedback by HR Committee';
                    MultiLine = true;
                }
            }
        }
        ...
        area(processing)
        {
            action(Post)
            {
                ...
                begin
                    ...
                    IF Appraisal.FIND('-') THEN BEGIN
                        IF IsAppraised2 = FALSE THEN BEGIN
                            Appraisal."Total App2" := CalculateAppraisalScore;

                            Appraisal.IsAppraised2 := TRUE;
                            "Appraisal 2 UserID" := USERID;
                            Appraisal."Appraised 2 Date" := TODAY;
                            Appraisal.MODIFY;
                            Appraisal."Overall Rating" := CalculateOverallRating;
                            Appraisal.MODIFY;
                            //"Total App2" := CalculateAppraisalScore;
                            //IsAppraised2 := TRUE;
                            // "Appraised 2 Date" := TODAY;
                            //"Appraised By" := "Appraised By"::"2";
                            MESSAGE('Second Appraisal done Successfully');
                        END ELSE BEGIN
                            //MESSAGE('ERRRRRRRRRRRRR');
                            Appraisal."Total App2" := 0;
                            Appraisal."Total App2" := CalculateAppraisalScore;
                            Appraisal."Overall Rating" := CalculateOverallRating;
                            Appraisal.MODIFY;
                    ...
                    /*
                    EmpAppraisal.RESET;
                    EmpAppraisal.SETRANGE(EmpAppraisal."Employee Code","Employee Code");
                    EmpAppraisal.SETRANGE(EmpAppraisal."Entry No.","Entry No.");
                    IF EmpAppraisal.FINDFIRST THEN BEGIN
                       REPORT.RUNMODAL(33020328,TRUE,FALSE,EmpAppraisal);
                    END;
                    */
            ...
            action(Print)
            {
                ...
                begin
                    ...
                    EmpAppraisal.SETRANGE(EmpAppraisal."Entry No.", "Entry No.");
                    IF EmpAppraisal.FINDFIRST THEN BEGIN
                        EmpAppraisal.SETRANGE(EmpAppraisal.Category, 'CAT-1');
                        IF EmpAppraisal.FINDFIRST THEN
                            REPORT.RUNMODAL(33020328, TRUE, FALSE, EmpAppraisal);
                        EmpAppraisal.SETRANGE(EmpAppraisal.Category, 'CAT-2');
                        IF EmpAppraisal.FINDFIRST THEN
                            REPORT.RUNMODAL(33020329, TRUE, FALSE, EmpAppraisal);

                        /*
                           IF EmpAppraisal.Category = 'CAT-1' THEN BEGIN
                              REPORT.RUNMODAL(33020328,TRUE,FALSE,EmpAppraisal);
                           END;
                           IF EmpAppraisal.Category = 'CAT-2' THEN BEGIN
                              REPORT.RUNMODAL(33020329,TRUE,FALSE,EmpAppraisal);
                           END;
                          */
                        // REPORT.RUNMODAL(33020328,TRUE,FALSE,EmpAppraisal);
