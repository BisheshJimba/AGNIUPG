codeunit 33020510 "Temporary Procedures range"
{
    ...
    begin
        ...
        ItemLedgEntry.SETRANGE("Posting Date", 071622D, TODAY);
    ...
    begin
        ...
        TransferShipmentHeader.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        TransferReceiptHeader.SETRANGE("Posting Date", 071622D, TODAY);
    ...
    begin
        ...
        PurchRcptHdr.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        PurchRcptLine.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        PurchInvHeader.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        PurchInvLine.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        ReturnReceiptHeader.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        ReturnReceiptLine.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        PurchCrMemoHdr.SETRANGE("Posting Date", 071622D, TODAY);
        ...
        PurchCrMemoLine.SETRANGE("Document No.", GLAccountNetChange."No.");
    ...
    local procedure UnblockDimension()
    var
        DimensionValue: Record "349";
    begin
        DimensionValue.RESET;
        DimensionValue.SETRANGE(Blocked, TRUE);
        DimensionValue.MODIFYALL(Blocked, FALSE);
    end;

    local procedure UpdateDocumentNumber()
    var
        GLEntry: Record "17";
            ...
            REPEAT
                ...
                IF GLItemLedgerRelation.FINDFIRST THEN
                    REPEAT
                        ...
                        IF ValueEntry.FINDFIRST THEN
                            REPEAT
                                GLEntry."Document No." := ValueEntry."Document No.";
                                GLEntry.MODIFY;
                            UNTIL ValueEntry.NEXT = 0;
