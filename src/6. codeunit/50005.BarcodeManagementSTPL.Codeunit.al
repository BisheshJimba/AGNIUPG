codeunit 50005 "Barcode Management - STPL"
{
    // Stijn Bossuyt
    ...
    trigger OnRun()
    var
        lrecTmpBlob: Record "99008535" temporary;
    begin
    end;
    ...
    [Scope('Internal')]
    procedure EncodeEAN13(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "99008535" temporary)
    var
    ...
    [Scope('Internal')]
    procedure EncodeCode128(pcodBarcode: Code[1024]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "99008535" temporary)
    var
        lrecTmpCode128: Record "50008" temporary;
        lintCount1: Integer;
    ...
    [Scope('Internal')]
    procedure EncodeCode39(pcodBarcode: Code[1024]; pintSize: Integer; pblnCheckDigit: Boolean; pblnVertical: Boolean; var precTmpTempBlob: Record "99008535" temporary)
    var
        lrecTmpCode39: Record "50008" temporary;
        lintCount1: Integer;
        lintSum: Integer;
        lintConvInt: Integer;
        lintCheckDigit: Integer;
    ...
    [Scope('Internal')]
    procedure EncodeEAN8(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "99008535" temporary)
    var
        ltxtWeight: Text[12];
        ltxtSentinel: Text[3];
        ltxtCenterGuard: Text[6];
    ...
    local procedure InitCode128(var precTmpCode128: Record "50008" temporary)
    begin
        precTmpCode128.INIT;
    ...
    local procedure InitCode39(var precTmpCode39: Record "50008" temporary)
    begin
